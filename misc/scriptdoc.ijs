NB. built from project: ~Source/main/script/script
NB. script description
NB. Modified for use with the jhs cobrowser
...
0 xdoc y
:
if. #y do. y=. y,PATHSEP_j_ -. {:y end.
x=. scriptlist 1 dir y,'*.ijs'
dat=. (x }. each {."1 x) ,. }."1 x
wdclipwrite clipfmt dat
dat
)
...
SDOC=: 0 : 0
pc sdoc closeok;pn "scriptdoc";
xywh 5 1 54 10;cc sum checkbox;cn "Summary";
xywh 194 1 31 10;cc ptop checkbox leftmove rightmove;cn "&Top";
