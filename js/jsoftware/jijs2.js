...
import { EditorState } from '../codemirror6/state/dist/index.js';
import { history, defaultKeymap, historyKeymap } from '../codemirror6/commands/dist/index.js';
import { closeBrackets, closeBracketsKeymap } from '../codemirror6/autocomplete/dist/index.js';
import { search, searchKeymap, openSearchPanel, highlightSelectionMatches } from '../codemirror6/search/dist/index.js';
...
export const lightSelenizedTheme = EditorView.theme({
  "&": {
    color: lfg1,
...
let lightSelenizedHighlight = HighlightStyle.define([
...
function createEditor(text) {
  return new EditorView({
    ...
    parent: document.getElementById("ijs2")
  });
}
